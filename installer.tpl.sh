...
install_apt ()
{
  ...
  echo "deb https://download.tarantool.org{% if usr_id %}/{{ usr_id }}{% endif %}/tarantool/${dist_path}/ ${dist_ver} main" > ${apt_source_path}
  echo "deb-src https://download.tarantool.org{% if usr_id %}/{{ usr_id }}{% endif %}/tarantool/${dist_path}/ ${dist_ver} main" >> ${apt_source_path}
...
baseurl=https://download.tarantool.org{% if usr_id %}/{{ usr_id }}{% endif %}/tarantool/${repo_ver_path}/${dist_code}/${dist_ver}/${ARCH}/
...
baseurl=https://download.tarantool.org{% if usr_id %}/{{ usr_id }}{% endif %}/tarantool/${repo_ver_path}/${dist_code}/${dist_ver}/SRPMS
gpgkey=https://download.tarantool.org/tarantool/${repo_ver_path}/gpgkey
repo_gpgcheck=1
gpgcheck=0
